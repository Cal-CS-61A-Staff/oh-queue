    ...
    render() {
        ...
        let queueMagicWordOptions = [
            <div className="form-group">
                <select className="form-control" value={this.state.queueMagicWordMode}
                        onChange={this.changeQueueMagicWordMode}>
            ...
            queueMagicWordOptions.push(
                <div className="form-group">
                    <input type="text" className="form-control"
                           value={this.state.queueMagicWordData}
                           onChange={this.changeQueueMagicWordData} required="required"/>
                </div>
            );
        }
        queueMagicWordOptions.push(<button className="btn btn-default" name="btn-submit"
                                ...
                                <form onSubmit={this.submitJugglingTimeout}>
                                    <div className="form-group">
                                        <input type="number" className="form-control"
                                               value={this.state.jugglingTimeout}
                                               onChange={this.changeJugglingTimeout}
                                               required="required"/>
                                    </div>
                                    <button className="btn btn-default" name="btn-submit"
                                            type="submit">Save
                                    </button>
                                </form>
                            </td>
